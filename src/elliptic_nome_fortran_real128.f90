module elliptic_nome_fortran_real128
    ...
    public :: elliptic_nome_01_real128
    public :: elliptic_nome_05_real128
    public :: elliptic_nome_09_real128
    public :: elliptic_nome_13_real128
    public :: elliptic_nome_17_real128
    public :: elliptic_nome_21_real128
    public :: elliptic_nome_25_real128
    public :: elliptic_nome_29_real128
    public :: elliptic_nome_33_real128
    public :: elliptic_nome_auto_real128



    real(real128), parameter :: c_01 =        1.0_real128
    real(real128), parameter :: c_05 =        2.0_real128
    real(real128), parameter :: c_09 =       15.0_real128
    real(real128), parameter :: c_13 =      150.0_real128
    real(real128), parameter :: c_17 =     1707.0_real128
    real(real128), parameter :: c_21 =    20910.0_real128
    real(real128), parameter :: c_25 =   268616.0_real128
    real(real128), parameter :: c_29 =  3567400.0_real128
    real(real128), parameter :: c_33 = 48555069.0_real128

    real(real128), parameter :: q_err = tiny(0.0_real128)
    ...
    elemental function elliptic_nome_01_real128(k) result(q)
        ...
        real(real128) :: comp_k !! \( { k }^{ \prime } \)

        real(real128) :: pw02_k !! \( { k }^{ 2 } \)

        real(real128) :: sqrt_comp_k !! \( \sqrt{ { k }^{ \prime } } \)
    ...
    end function elliptic_nome_01_real128



    elemental function elliptic_nome_05_real128(k) result(q)
        !! Calculate the elliptic nome \( q \) using
        !! the Horner's method and
        !! the following polynomial:
        !! $$
        ...
        real(real128) :: pw01_eps !! auxiliary parameter \( \varepsilon \)

        real(real128) :: pw04_eps !! \( { \varepsilon }^{ 4 } \)
    ...
    end function elliptic_nome_05_real128



    elemental function elliptic_nome_09_real128(k) result(q)
        !! Calculate the elliptic nome \( q \) using
        !! the Horner's method and
        !! the following polynomial:
        !! $$
    ...
    end function elliptic_nome_09_real128



    elemental function elliptic_nome_13_real128(k) result(q)
        !! Calculate the elliptic nome \( q \) using
        !! the Horner's method and
        !! the following polynomial:
        !! $$
    ...
    end function elliptic_nome_13_real128



    elemental function elliptic_nome_17_real128(k) result(q)
        !! Calculate the elliptic nome \( q \) using
        !! the Horner's method and
        !! the following polynomial:
        !! $$
    ...
    end function elliptic_nome_17_real128



    elemental function elliptic_nome_21_real128(k) result(q)
        !! Calculate the elliptic nome \( q \) using
        !! the Horner's method and
        !! the following polynomial:
        !! $$
    ...
    end function elliptic_nome_21_real128



    elemental function elliptic_nome_25_real128(k) result(q)
        !! Calculate the elliptic nome \( q \) using
        !! the Horner's method and
        !! the following polynomial:
        !! $$
    ...
    end function elliptic_nome_25_real128



    elemental function elliptic_nome_29_real128(k) result(q)
        !! Calculate the elliptic nome \( q \) using
        !! the Horner's method and
        !! the following polynomial:
        !! $$
    ...
    end function elliptic_nome_29_real128



    elemental function elliptic_nome_33_real128(k) result(q)
        !! Calculate the elliptic nome \( q \) using
        !! the Horner's method and
        !! the following polynomial:
        !! $$
    ...
    end function elliptic_nome_33_real128
    ...
    end function elliptic_nome_auto_real128
    ...
    elemental subroutine calculate_pw01_epsilon(pw02_k, comp_k, sqrt_comp_k, pw01_eps)
        ...
        real(real128) :: pls1_comp_k !! \( 1 + { k }^{ \prime } \)



        pls1_comp_k =      comp_k  + 1.0_real128
        sqrt_comp_k = sqrt(comp_k)

        pw01_eps = 0.5_real128 * pw02_k &!
...
end module elliptic_nome_fortran_real128
