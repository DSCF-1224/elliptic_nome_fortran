program check_real128
    ...
    subroutine check
        ...
        real(real128), allocatable, dimension(:) :: num_k, num_q_ref

        real(real128), allocatable, dimension(:,:) :: num_q_err, num_q_res
        ...
        do itr = 1, cnt_k
            ...
            write( &!
            unit   = file_unit , &!
            fmt    = '(SP,A,A,A,ES44.35E4,A,ES44.35E4,A)' , &!
            iostat = stat      , &!
            iomsg  = msg         &!
            ) &!
    ...
    subroutine check_kernel(k, q_ref, q_res, q_err)
        ...
        real(real128), intent(in) :: k

        real(real128), intent(in) :: q_ref

        real(real128), intent(out), dimension(10) :: q_res, q_err
    ...
    subroutine read_values(file, counter, stat, msg, num, str)
        ...
        real(real128), intent(inout), allocatable :: num(:)
