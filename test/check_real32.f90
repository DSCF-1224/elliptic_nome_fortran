program check_real32
    ...
    subroutine check
        ...
        real(real32), allocatable, dimension(:) :: num_k, num_q_ref

        real(real32), allocatable, dimension(:,:) :: num_q_err, num_q_res
        ...
        do itr = 1, cnt_k
            ...
            write( &!
            unit   = file_unit , &!
            fmt    = '(SP,A,A,A,ES15.08E2,A,ES15.08E2,A)' , &!
            iostat = stat      , &!
            iomsg  = msg         &!
            ) &!
    ...
    subroutine check_kernel(k, q_ref, q_res, q_err)
        ...
        real(real32), intent(in) :: q_ref

        real(real32), intent(out), dimension(10) :: q_res, q_err
    ...
    subroutine read_values(file, counter, stat, msg, num, str)
        ...
        real(real32), intent(inout), allocatable :: num(:)
